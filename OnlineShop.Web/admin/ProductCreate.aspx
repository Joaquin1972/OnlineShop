    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8 col-12">
                <%--Label y text box para el nombre del producto--%>
                ...
                <%--Label y text box para la descripción del producto--%>
                <div class="row mb-3 mt-3">
                ...
                <%--Label y text box para el stock del producto--%>
                <div class="row mb-3 mt-3">
                ...
                <%--Label y text box para el precio del producto--%>
                <div class="row mb-3 mt-3">
                    ...
                    <asp:RangeValidator ID="RangeValidator1"
                        ...
                        Display="Dynamic" ControlToValidate="txtPrice"
                        MaximumValue="50"
                        MinimumValue="0"
                        Text="Precio fuera de rango">
                    </asp:RangeValidator>
                </div>
                 <%--Label y botón para cargar la foto del producto--%>
                <div class="row mb-3 mt-3">
                 ...
                 <%--Label y botón para subir la foto del producto al servidor--%>
                ...
                <%--Label para informar de producto creado--%>
                <div class="row mb-3 mt-4">
