...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <div class="row">
        ...
        <asp:Button ID="txtUpdate" runat="server" CssClass="offset-2 col-md-1 btn btn-primary" Text="Actualizar" OnClick="txtUpdate_Click" />
        <asp:Button ID="txtDelete" runat="server" CssClass="offset-1 col-md-1 btn btn-secondary" Text="Eliminar" OnClick="txtDelete_Click" />
    </div>
    <hr />
    <%--<a href="CategoryCreate.aspx">Volver a Crear Categorías</a>--%>
</asp:Content>
